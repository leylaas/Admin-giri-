...
import 'package:shopsmart_admin_en_two/models/dashboard_btn_model.dart';
import 'package:shopsmart_admin_en_two/widgets/dashboard_btns.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const TitlesTextWidget(label: "Kontrol Ekranı"),
          leading: Padding(
