...
import 'package:shopsmart_admin_en_two/consts/app_constants.dart';
import 'package:shopsmart_admin_en_two/models/product_model.dart';
import 'package:shopsmart_admin_en_two/services/my_app_method.dart';
import 'package:shopsmart_admin_en_two/widgets/subtitle_text.dart';
  ...
  Future<void> _uploadProduct() async {
    ...
    if (_pickedImage == null) {
      MyAppMethods.showErrorORWarningDialog(
        context: context,
        subtitle: "Resim eklendiğinden emin olun ",
        fct: () {},
      );
      return;
    }
    ...
    if (isValid) {
      ...
      try {
        ...
        await MyAppMethods.showErrorORWarningDialog(
          context: context,
          subtitle: "Bir hata oluştu $error",
          fct: () {},
        );
      } finally {
        setState(() {
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(
                      isEditing ? "Ürün güncelle" : "Ürün ekle",
              ...
              child: Column(
                children: [
                    ...
                    Row(
                      ...
                      children: [
                        TextButton(
                          ...
                          child: const Text("Farklı bir resim seçin"),
                        ),
                        TextButton(
                          onPressed: () {
                            removePickedImage();
                  ...
                  DropdownButton<String>(
                    hint: Text(_categoryValue ?? "Kategori Seç"),
                        ...
                        children: [
                              ...
                              Flexible(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    return MyValidators.uploadProdTexts(
                                      value: value,
                                      toBeReturnedString: "Fiyat Girilmedi",
                                    );
                                  },
                                ),
                              ),
                              ...
                              Flexible(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (value) {
                                    return MyValidators.uploadProdTexts(
                                      value: value,
                                      toBeReturnedString: "Ürün adedi girilmedi",
                                    );
                                  },
                                ),
                              ),
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              return MyValidators.uploadProdTexts(
                                value: value,
                                toBeReturnedString: "Ürün açıklaması girilmedi",
                              );
                            },
                            onTap: () {},
                          ),
